    ...
    <section className="hero" id="validate">
      <div className="container">
        <h1>
          ...
          <span style={{ marginTop: '30px', display: 'inline-block', verticalAlign: 'top' }}>is Coming Soon</span>
        </h1>
        <p>
        ...
        <div className="signup-form-header" id="heroValidateHeader">
        </div>
        ...
        <div className="embedded-form-container" id="heroSurvey">
          ...
          <div className="embedded-form-wrapper" style={{ display: formLoaded ? 'block' : 'none' }} id="formWrapper">
            <iframe 
