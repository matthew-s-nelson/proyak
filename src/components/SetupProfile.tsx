                    ...
                    await supabase.functions.invoke(
                        "create-candidate-profile",
                        {
                            body: {
                                ...
                                interest_ids: selectedInterests.map(
                                    (i) => i.id
                                ),
                            },
                        }
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Employee/company fit is a two way street. That's why we want
                    to hear about you! What type of worker are you, where do you
                    see yourself ending up, what environments do you thrive in:
                    all of these answers will help us pair you with compatible
                    companies.
                </p>
            </div>
            {/* Form Section */}
